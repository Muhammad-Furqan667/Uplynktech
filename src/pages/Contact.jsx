...
export default function Contact() {
  ...
  const contactMetas = [
    { icon: FiMail, label: 'Technical Inquiries', value: 'engineering@uplynktech.com', link: 'mailto:engineering@uplynktech.com' },
    { icon: FiPhone, label: 'Direct Line', value: '+92 300 000 0000', link: 'tel:+923000000000' },
    { icon: FiMapPin, label: 'H.Q. Hub', value: 'Markup Building, Blue Area, Islamabad', link: '#' },
